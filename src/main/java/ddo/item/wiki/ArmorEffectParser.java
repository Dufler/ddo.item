...
@Component
public class ArmorEffectParser extends AItemParser {
	...
	protected Item parseItem(Element row, ItemType type) {
		...
		while (iterator.hasNext()) {
			...
			switch (columnIndex % 10) {
				...
				case 5 : parseArmorCheckPenality(e); break;
				case 6 : parseArcaneSpellFailure(e); break;
				case 7 : parseMaterial(e); break;
				case 8 : parseBinding(e); break;
				case 9 : parseQuest(e); break;
