-- stat drain
insert into effect(name, effect_type) values ('Bewildering', 'debuff');
...
insert into effect(name, effect_type) values ('Critical Wounding', 'debuff');
...
insert into effect(name, effect_type) values ('Crippling', 'debuff');
insert into effect(name, effect_type) values ('Crippling Flames', 'debuff');
...
insert into effect(name, effect_type, description) values ('Improved Quelling Strikes', 'debuff', 'On Vorpal Melee: applies a Quell effect to target enemy for six seconds, rendering them unable to cast divine spells. This has a 50% chance of preventing the target from casting all spells for three seconds (12 second cooldown).');
insert into effect(name, effect_type) values ('Tendon Slice', 'debuff');
insert into effect(name, effect_type) values ('Weaken Construct', 'debuff');
insert into effect(name, effect_type) values ('Weaken Undead', 'debuff');
insert into effect(name, effect_type) values ('Improved Destruction', 'debuff');
insert into effect(name, effect_type) values ('Transmuted Platinum', 'debuff');
